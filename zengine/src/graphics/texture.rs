...
pub struct TextureBuilder<'a, ST: SpriteType> {
    file_path: String,
    texture_manager: &'a mut TextureManager<ST>,
    sprites: HashMap<ST, SpriteDescriptor>,
}

impl<'a, ST: SpriteType> TextureBuilder<'a, ST> {
...
pub struct TextureManager<ST: SpriteType> {
    sprites: HashMap<ST, SpriteHandle>,
}
impl<ST: SpriteType> Resource for TextureManager<ST> {}
...
impl<ST: SpriteType> TextureManager<ST> {
    pub fn build(&mut self, file_path: &str) -> TextureBuilder<ST> {
        TextureBuilder {
    ...
    pub fn load(&mut self, file_path: &str, sprites: HashMap<ST, SpriteDescriptor>) {
    ...
    pub fn texture_still_used(&self, texture_id: u32) -> bool {
        self.sprites
            .values()
    ...
    pub fn generate_texture(width: u32, height: u32, data: &[u8]) -> u32 {
    ...
    pub fn destroy_texture(texture_id: u32) {
        unsafe {
